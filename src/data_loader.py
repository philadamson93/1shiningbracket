...
TEAM_ALIASES = {
    ...
    "TCU": ["TCU", "TCU Horned Frogs", "Texas Christian"],
    ...
    "Saint Mary's": ["Saint Mary's", "St. Mary's", "Saint Mary's Gaels", "Saint Mary's (CA)"],
    "BYU": ["BYU", "BYU Cougars", "Brigham Young"],
    "Wisconsin": ["Wisconsin", "Wisconsin Badgers"],
    "Texas Tech": ["Texas Tech", "Texas Tech Red Raiders"],
    "Miami FL": ["Miami FL", "Miami (FL)", "Miami Hurricanes", "Miami (Fl.)"],
    "Miami OH": ["Miami OH", "Miami (OH)", "Miami RedHawks", "Miami (Oh.)", "Miami (Ohio)"],
    "UCF": ["UCF", "UCF Knights"],
    ...
    "SMU": ["SMU", "SMU Mustangs", "MOH/SMU", "M-OH/SMU", "Southern Methodist"],
    "NC State": ["NC State", "N.C. State", "NC State Wolfpack", "North Carolina State"],
    ...
    "North Dakota St": ["North Dakota St", "North Dakota St.", "North Dakota State", "N. Dak. St.", "NDSU", "North Dakota State Bison", "North Dakota St Bison"],
    "Furman": ["Furman", "Furman Paladins"],
    "Siena": ["Siena", "Siena Saints"],
    "LIU": ["LIU", "LIU Brooklyn", "Long Island"],
    "Howard": ["Howard", "Howard Bison", "UMBC/HOW"],
    "Lehigh": ["Lehigh", "Lehigh Mountain Hawks", "PV/LEH", "Prairie View A&M Panthers", "Prairie View Panthers"],
    ...
    "Texas": ["Texas", "Texas Longhorns", "TX/NCST"],
    ...
    "South Dakota State": ["South Dakota State", "South Dakota St", "S Dakota St"],
    ...
    "UAB": ["UAB", "UAB Blazers", "Alabama-Birmingham"],
    ...
    # Historical 538 names (2018-2023) that differ from bracket canonical names
    "Georgia Tech": ["Georgia Tech", "Georgia Tech Yellow Jackets"],
    "Virginia Tech": ["Virginia Tech", "Virginia Tech Hokies", "VT"],
    "Oregon State": ["Oregon State", "Oregon St", "Oregon State Beavers"],
    "Arizona State": ["Arizona State", "Arizona St", "Arizona State Sun Devils", "ASU"],
    "Penn State": ["Penn State", "Penn St", "Penn State Nittany Lions"],
    "Georgia State": ["Georgia State", "Georgia St", "Georgia State Panthers"],
    "UNC Greensboro": ["UNC Greensboro", "North Carolina-Greensboro", "UNCG"],
